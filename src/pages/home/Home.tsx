            ...
            <div className="mx-24 mt-10">
                ...
                <div className="flex justify-center gap-14 text-qms mt-16">
                    <div className="mr-14">
                        ...
                        <p className="text-xl mt-5">We have integrated the experience of many quality engineers and made a tool that indicates the exact quality value of your project based on the development management system and the coverage of their checks.</p>
                    </div>
                    <div>
                        <p className="text-2xl font-bold mb-3">Approach</p>
                        <p className="text-xl mt-5">Based on our practical experience, we have created a system that allows you to obtain an assessment of the quality of coverage by inspection of any project of any size. The system is suitable form many areas: Internet technology, device design, manufacturing, aircraft manufacturing, etc.</p>
                    </div>
                </div>
                ...
                <div className="flex justify-start gap-20 mt-24">
                    ...
                    <div>
                        ...
                        <button className="btn-qms py-3 px-10 mt-5 mb-10"><a href="/free-trial">Get Started</a></button>
                    </div>
                </div>
            </div>
        </>
